      ...
      <div className="min-h-screen bg-gradient-to-br from-white to-pink-50 py-8">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Checking your membership...</h2>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-white to-pink-50 py-8">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-gradient-to-br from-pink-500 to-orange-500 rounded-full p-6 inline-block mb-6">
              <svg className="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
            </div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Premium Membership Active! 🎉</h1>
    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-pink-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Silver Plan */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 shadow-xl transform hover:scale-105 transition-all duration-300">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Silver Plan</h2>
          ...
          {/* Gold Plan - Featured */}
          <div className="bg-gradient-to-br from-pink-500 to-orange-500 rounded-2xl p-8 border border-pink-400 shadow-2xl transform hover:scale-105 transition-all duration-300 relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <span className="bg-white text-pink-600 px-4 py-1 rounded-full text-sm font-bold shadow-lg">
                MOST POPULAR
              </span>
            </div>
            ...
            <button
              ...
              disabled={processingType}
              className="w-full bg-white text-pink-600 font-bold py-4 px-6 rounded-xl hover:shadow-lg transform hover:scale-105 disabled:opacity-50 disabled:transform-none transition-all duration-300"
            >
              {processingType === "gold" ? (
                <div className="flex items-center justify-center">
                  <div className="animate-spin rounded-full h-5 w-5 border-t-2 border-b-2 border-pink-600 mr-2"></div>
                  Processing...
                </div>
              ) : (
                "Get Gold Plan"
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">All Premium Features</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Expand Network</h4>
              <p className="text-gray-600">Connect with unlimited developers and grow your professional circle</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Verified Badge</h4>
              <p className="text-gray-600">Get the blue verification badge and build trust in the community</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600">Find the perfect developer match with powerful filtering options</p>
            </div>
          </div>
        </div>
      </div>
